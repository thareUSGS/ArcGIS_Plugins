...
class Toolbox(object):
    def __init__(self):
        self.label =  "CTX Create Mosaic from ASU GeoTiffs toolbox"
        self.alias  = "CTX_CreateMosaic_fromASUgeoTiff"

        # List of tool classes associated with this toolbox
        self.tools = [CTX_CreateMosaic_fromASUgeoTiff] 

class CTX_CreateMosaic_fromASUgeoTiff(object):
    def __init__(self):
        self.label       = "CTX Create Mosaic from ASU GeoTiff toolbox"
    ...
    def execute(self, parameters, messages):
	    ...
	    #https://image.mars.asu.edu/stream/B01_009923_1790_XN_01S113W.tiff?image=/mars/images/ctx/mrox_0682/prj_full/B01_009923_1790_XN_01S113W.tiff
            UrlPath = "http://image.mars.asu.edu/stream/" + ProductId + ".tiff?image=/mars/images/ctx/" + volumeName + "/prj_full/" + ProductId + ".tiff"
            #show_msg =  UrlPath
            #arcpy.AddMessage(show_msg)
            ...
            if arcpy.Exists(outputImage):
                ...
                try:
                    h = urllib.urlretrieve(UrlPath, outputImage)
                     ...
                     show_msg = "WebSite issues for GeoTiff, cannot download: " + outputImage + " URL: " + UrlPath
                     arcpy.AddMessage(show_msg)
            aCnt = aCnt + 1
        ...
        if outputMosaicName:
            ...
            arcpy.AddRastersToMosaicDataset_management(theMosaic, "Raster Dataset", outputPath, "UPDATE_CELL_SIZES", "UPDATE_BOUNDARY", "NO_OVERVIEWS", "", "0", "1500", "", "*.tiff", "NO_SUBFOLDERS", "EXCLUDE_DUPLICATES", "NO_PYRAMIDS", "CALCULATE_STATISTICS", "NO_THUMBNAILS", "", "NO_FORCE_SPATIAL_REFERENCE")
